...
tunnel: simpletun simpletun_net simpletun_peer stop_tunnel $(SIMPLETUN_LOGS_DIR)
	$(SIMPLETUN_BINARY_DIR)/simpletun -v -i tun0 --peer-ip $(SIMPLETUN_PEER) --peer-port $(SIMPLETUN_PEER_PORT) --port $(SIMPLETUN_LOCAL_PORT) \
