...
int server_start(const char *cert_file, const char *pkey_file, const char *pkey_password,
                 const char *cli_socket, in_addr_t ip, in_port_t tcp_port, in_port_t udp_port,
